...
```javascript
stack = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/dstructs-stack@v0.1.1-umd/browser.js' )
```
...
[test-image]: https://github.com/stdlib-js/dstructs-stack/actions/workflows/test.yml/badge.svg?branch=v0.1.1
[test-url]: https://github.com/stdlib-js/dstructs-stack/actions/workflows/test.yml?query=branch:v0.1.1
